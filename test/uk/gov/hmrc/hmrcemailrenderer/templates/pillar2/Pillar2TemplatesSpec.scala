...
class Pillar2TemplatesSpec extends PlaySpec with CommonParamsForSpec {
  ...
  "GIR Successful Submission Template" must {
    ...
    "include htmlTemplate body with correct content" in {
      ...
      htmlContent must include("This is to confirm that HM Revenue and Customs received your GloBE Information Return on 01/01/2024 at 14:30")
    ...
    "include txtTemplate body with correct content" in {
      ...
      txtContent must include("This is to confirm that HM Revenue and Customs received your GloBE Information Return on 01/01/2024 at 14:30")
  ...
  "GIR Generic Errors Template" must {
    ...
    "include correct subject" in {
      genericErrorsTemplate.subject(paramsBase) mustBe "GloBE Information Return (GIR) – Errors Identified. Please Re-submit"
    }
