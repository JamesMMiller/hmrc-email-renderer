...
class Pillar2TemplatesSpec extends PlaySpec with CommonParamsForSpec {
  ...
  "pillar2_confirmation_email" must {
    ...
    "include default content for non-BTN request types" in {
      ...
      htmlContent must include("This is confirmation that on 3 October 2025 at 2:45pm HM Revenue & Customs received your Pillar 2 UK Tax Return for the Accounting Period 1 April 2024 to 31 March 2025.")
    ...
    "include plainTemplate body and footer for non-BTN request types" in {
      ...
      txtContent must include("This is confirmation that on 3 October 2025 at 2:45pm HM Revenue & Customs received your Pillar 2 UK Tax Return for the Accounting Period 1 April 2024 to 31 March 2025.")
    ...
    "include BTN-specific content for BTN request type" in {
      ...
      htmlContent must include("You have submitted a Below-Threshold Notification on 25 October 2024. This is effective from the start of the accounting period you selected, 10 October 2024.")
      htmlContent must include("What happens next")
      htmlContent must include("The Below-Threshold Notification satisfies your group's obligation to submit a UK Tax Return for the current and future accounting periods.")
      htmlContent must include("HMRC will not expect to receive an information return while your group remains below-threshold.")
      htmlContent must include("You must submit a UK Tax Return if your group meets the threshold conditions in the future.")
    ...
    "include BTN-specific content in plain text for BTN request type" in {
      ...
      txtContent must include("You have submitted a Below-Threshold Notification on 25 October 2024. This is effective from the start of the accounting period you selected, 10 October 2024.")
      txtContent must include("What happens next")
      txtContent must include("The Below-Threshold Notification satisfies your group's obligation to submit a UK Tax Return for the current and future accounting periods.")
      txtContent must include("HMRC will not expect to receive an information return while your group remains below-threshold.")
      txtContent must include("You must submit a UK Tax Return if your group meets the threshold conditions in the future.")
